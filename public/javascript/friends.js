...
export const friendsConfig = {
  ...
  tpl: f => {
    escapeFields(f, ['name', 'avatar', 'link']);
    return `
    <a target="_blank" rel="noopener noreferrer" href="${f.link}" aria-label="前往大電神 ${f.name} 的網站">
  ...
  suffix: `
    <a target="_blank" rel="noopener noreferrer" href="https://github.com/longtai-me/longtai-me/pulls">
      <div class="friend-card">
